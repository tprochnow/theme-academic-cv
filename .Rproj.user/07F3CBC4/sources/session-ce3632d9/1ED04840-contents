...
# url_slides = "#"
# url_video = "#"
 url_poster = "files/BGCAAHBMH.pdf"
# url_source = "#"
...
+++
<br /><br /> <iframe width="100%" height="350" name="iframe" src="/files/BGCMH_Dynamic.html"></iframe>
